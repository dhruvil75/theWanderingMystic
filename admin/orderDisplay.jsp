...
<head>
  ...
  <title>The Wandering Mystic | Orders</title>
...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                ...
                <!--<a href="orderAdd.jsp" class="btn btn-default pull-right">Add New</a>-->
              </div>
              <!-- /.box-header -->
              <div class="box-body">
  ...
  <script>
    $('.update-class').on('change', function (e) {
      ...
      $.ajax({
        url: "updateInTable.jsp?table=order&id=" + id + "&status=" + valueSelected,
        cache: false,
        type: 'GET',
        dataType: 'json',
